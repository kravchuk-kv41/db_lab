...
2. Реалізувати функціональні можливості згідно з вимогами, наведеними нижче.

#### Функціональні вимоги:
1. Розробити меню з можливістю перегляду, додавання, вилучення та модифікації наявних записів кожної з сутностей, пошуку згідно з варіантом та виходу з програми.
...
* Предметна галузь: Команда-Спортсмен
* Функція пошуку: Вивести найкращих спортсменів кожної команди